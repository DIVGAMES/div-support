...
BEGIN
    ...
    load("pacoman\pacoman.dat",&score_max);
...
BEGIN
    ...
    LOOP
        ...
        y=50+sin(timer[0]*4000)/100;//graphics_table[counter0];
        x=320+cos(timer[0]*4000)/50;
        FRAME;
    END
END
